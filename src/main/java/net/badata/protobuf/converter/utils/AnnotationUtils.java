...
public class AnnotationUtils {
     ...
     *                          public or can not be instantiated.
     */
    public static Mapper createMapper(final ProtoClass annotation) throws MappingException {
        try {
			...
			throw new MappingException("Could not instantiate " + annotation.fieldFactory().getSimpleName()+ "; NoSuchMethodException", e);
		} catch (InvocationTargetException e) {
			throw new MappingException("Could not instantiate " + annotation.fieldFactory().getSimpleName()+ "; InvocationTargetException", e);
		}
    }
     ...
     *                          default constructor not public or can not be instantiated.
     */
    ...
    public static TypeConverter<?, ?> createTypeConverter(final ProtoField annotation) throws WriteException {
        try {
			...
			throw new WriteException("Could not instantiate " + annotation.converter().getSimpleName()+ "; NoSuchMethodException", e);
		} catch (InvocationTargetException e) {
			throw new WriteException("Could not instantiate " + annotation.converter().getSimpleName()+ "; InvocationTargetException", e);
		}
	}
     ...
     *                        constructor not public or can not be instantiated.
     */
     ...
     *                        constructor is not public or can not be instantiated.
     */
